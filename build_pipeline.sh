...
EDDL_INSTALL_DIR=$UCP_PATH/deephealth/eddl/build/cmake
...
make -j$(nproc) && make install
OPENCV_INSTALL_DIR=$UCP_PATH/deephealth/opencv/build

############ ECVL
cd $UCP_PATH/deephealth
git clone https://github.com/deephealthproject/ecvl.git
cd ecvl
git checkout tags/v0.2.0  # Release 0.2.0
mkdir -p build && cd build
...
make -j$(nproc) && make install
ECVL_INSTALL_DIR=$UCP_PATH/deephealth/ecvl/build/install
