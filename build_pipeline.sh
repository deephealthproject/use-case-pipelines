...
cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=$BUILD_TYPE -DBUILD_TARGET=$DEVICE -DBUILD_TESTS=OFF -DBUILD_EXAMPLES=OFF -DCMAKE_INSTALL_PREFIX=install ..
...
cd ecvl
git checkout 5f12d36b9ef855a1710f882ad84c6d3f5b83136d # Latest master, waiting for the release
mkdir -p build && cd build
