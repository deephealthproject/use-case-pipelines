...
cd eddl
REM Latest master, waiting for the release
git checkout e16cbdbba3796e9e12969c9a939eaf6530eb5454
...
set ZLIB_ROOT=%UCP_PATH%/%DEPENDENCIES_DIR%/eddl/build/cmake/third_party/zlib
...
cd ecvl
REM Latest master, waiting for the release
git checkout 5f12d36b9ef855a1710f882ad84c6d3f5b83136d
mkdir build & cd build
